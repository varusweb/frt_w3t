...
function setTonkeeper() {
    ...
    var authRequestUrl = 'hueton.ru/authRequest';
    var loginLink = 'https://app.tonkeeper.com/ton-login/' + authRequestUrl;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setTonkeeper();
                    return [4 /*yield*/, (0, tonhub_1.getSession)()];
                case 1:
                    session = _a.sent();
                    ...
                    return [4 /*yield*/, (0, tonhub_1.waitSession)(session.id)];
                case 2:
                    result = _a.sent();
